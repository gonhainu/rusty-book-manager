...
use crate::database::model::book::{BookCheckoutRow, BookRow, PaginateBookRow};
...
impl BookRepository for BookRepositoryImpl {
    ...
    async fn find_all(&self, options: BookListOptions) -> AppResult<PaginatedList<Book>> {
        ...
        let rows: Vec<PaginateBookRow> = sqlx::query_as!(
            PaginateBookRow,
            r#"
                SELECT
                    COUNT(*) OVER() AS "total!",
        ...
        let rows: Vec<BookRow> = sqlx::query_as!(
            ...
            r#"
                ...
                WHERE b.book_id IN (SELECT unnest($1::uuid[]))
                ORDER BY b.created_at DESC
            "#,
            &book_ids as _
        )
